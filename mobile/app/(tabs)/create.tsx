...
export default function Create(): JSX.Element {
  ...
  }, [caption, image, imageBase64, rating, router, title, token]);

  const renderRatingPicker = useCallback((): JSX.Element => {
      ...
      <ScrollView contentContainerStyle={styles.container} style={styles.scrollViewStyle}>
        <View style={styles.card}>
          ...
          <View style={styles.header}>
            <Text style={styles.title}>책 추천 추가하기</Text>
            <Text style={styles.subtitle}>좋아하는 책을 다른 사람과 나누세요</Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            {/* RATING */}
            <View style={styles.formGroup}>
              <Text style={styles.label}>나의 평점</Text>
              {renderRatingPicker()}
            </View>

            {/* IMAGE */}
            <View style={styles.formGroup}>
              <Text style={styles.label}>책 이미지</Text>
              <TouchableOpacity style={styles.imagePicker} onPress={pickImage}>
                {image ? (
                  ...
                  <View style={styles.placeholderContainer}>
                    ...
                    <Text style={styles.placeholderText}>탭하여 이미지를 선택하세요</Text>
                  </View>
                )}
              </TouchableOpacity>
            </View>
